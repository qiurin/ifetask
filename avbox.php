...
$mail = 'qlhlhw@gmail.com';//若有恶意登录，会发邮件到这个邮箱，前提是mail()函数可用！
...
function mainbottom() {
    echo "</div><div style='text-align:center;font-size:13px;color:#999 !important;margin-top:5px;margin-bottom:45px'>"
        ."<a style='color:#999' href='http://www.sdo.com'>盛大网络</a> FileBox Version 1.6.1 <a href='http://www.sdo.com' style='color:#999'>View Update</a></div></body>\n"
        ."</html>\n";
    exit;
}
